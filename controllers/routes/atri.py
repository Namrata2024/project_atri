...
class Atri:
	def __init__(self, state: Any):
		...
		self.nav_box = state["nav_box"]
		self.Flex3 = state["Flex3"]
		self.links_list = state["links_list"]
		self.Flex4 = state["Flex4"]
		self.section_1 = state["section_1"]
		self.leftbox = state["leftbox"]
		self.Div3 = state["Div3"]
		self.Div4 = state["Div4"]
		self.Flex10 = state["Flex10"]
		self.rightbox = state["rightbox"]
	...
	def root(self, new_state):
		...
		global default_state
		self._root = Flex(new_state, default_state["root"])
	...
	@property
	def nav_box(self):
		self._getter_access_tracker["nav_box"] = {}
		return self._nav_box
	@nav_box.setter
	def nav_box(self, new_state):
		self._setter_access_tracker["nav_box"] = {}
		global default_state
		self._nav_box = Flex(new_state, default_state["nav_box"])
	...
	@property
	def links_list(self):
		self._getter_access_tracker["links_list"] = {}
		return self._links_list
	@links_list.setter
	def links_list(self, new_state):
		self._setter_access_tracker["links_list"] = {}
		global default_state
		self._links_list = Flex(new_state, default_state["links_list"])
	...
	@property
	def section_1(self):
		self._getter_access_tracker["section_1"] = {}
		return self._section_1
	@section_1.setter
	def section_1(self, new_state):
		self._setter_access_tracker["section_1"] = {}
		global default_state
		self._section_1 = Flex(new_state, default_state["section_1"])

	@property
	def leftbox(self):
		self._getter_access_tracker["leftbox"] = {}
		return self._leftbox
	@leftbox.setter
	def leftbox(self, new_state):
		self._setter_access_tracker["leftbox"] = {}
		global default_state
		self._leftbox = Flex(new_state, default_state["leftbox"])
	...
	@property
	def rightbox(self):
		self._getter_access_tracker["rightbox"] = {}
		return self._rightbox
	@rightbox.setter
	def rightbox(self, new_state):
		self._setter_access_tracker["rightbox"] = {}
		global default_state
		self._rightbox = Flex(new_state, default_state["rightbox"])
	...
	def _to_json_fields(self):
		return {
			"root": self._root,
			"main": self._main,
			"nav_box": self._nav_box,
			"Flex3": self._Flex3,
			"links_list": self._links_list,
			"Flex4": self._Flex4,
			"section_1": self._section_1,
			"leftbox": self._leftbox,
			"Div3": self._Div3,
			"Div4": self._Div4,
			"Flex10": self._Flex10,
			"rightbox": self._rightbox,
			"Flex11": self._Flex11,
			"Div5": self._Div5,
			"Flex13": self._Flex13,
			"Flex16": self._Flex16,
